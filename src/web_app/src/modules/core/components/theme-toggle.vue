<template>
	<div class="toggle">
		<input class="toggle-input" type="checkbox" @click="toggle" />
		<div class="toggle-bg" />
		<div class="toggle-switch">
			<div class="toggle-switch-figure" />
			<div class="toggle-switch-figureAlt" />
		</div>
	</div>
</template>
...
const modelValue = defineModel<boolean>({ required: true, type: Boolean });
