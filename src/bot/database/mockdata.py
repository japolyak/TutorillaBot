...
from src.bot.database.models import User, Subject, TutorCourse, PrivateCourse, PrivateClass, Textbook
from src.bot.api.models import SourceDto
from src.bot.config import dev_tg_id, admin_tg_id
...
def insert_mock_data(engine: Engine):
    with Session(engine) as session:
        ...
        artem = User(
            id=dev_tg_id, first_name="Artem", is_active=True, time_zone=1, last_name="Kryvolap", email="me@me.com",
