...
from src.bot.handlers.callback_query_handler.callback_prefix import CallBackPrefix
from src.bot.handlers.callback_query_handler.actions.shared_actions import SharedActions
from src.bot.handlers.callback_query_handler.actions.student_actions import StudentActions
from src.bot.handlers.callback_query_handler.actions.tutor_actions import TutorActions
from src.bot.handlers.callback_query_handler.actions.admin_actions import AdminActions
from src.bot.handlers.callback_query_handler.actions.registration_actions import RegistrationActions
